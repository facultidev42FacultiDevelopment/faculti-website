...
const CATEGORIES = [
  ...
  { id: "social", name: "Social Sciences", active: false },
  { id: "sciences", name: "Sciences", active: false },
  { id: "arts", name: "Arts and Humanities", active: false },
]
...
export default function ResearchCarousel({ posts }: ResearchCarouselProps) {
  ...
  const researcherCards = useMemo(() => {
    return posts.map((researcher) => (
      <div
        key={researcher.id}
    ...
    <section className="w-full bg-background py-2">
      <div className="w-full px-2">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-3">
          <h2 className="text-lg sm:text-xl font-bold">Research</h2>
